%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% model = scaleBioMass_modified(model,Ptot,GAM,scale_comp)
% 
...
% Carl Malina.      Last update: 2020-09-11
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [model,GAM] = scaleBioMass_modified(model,Ptot,GAM,scale_comp)
if nargin < 3
    GAM = [];
end
...
if isempty(GAM)
    GAM = fitGAM_modified(model,true);
end
%Change GAM:
...
if sum(rxnPos) == 1
    for i = 1:length(model.mets)
        % ignore scaling prosthetic groups pseudometabolite in protein
        % pseudoreaction
        if strcmp(model.metNames{i},'prosthetic groups')
            continue
        end
